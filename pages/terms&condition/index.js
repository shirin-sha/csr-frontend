...
<main className={styles.main}>
  ...
  <section className={styles.termstitle}>
...
If you still have not received your purchase after the above mentioned times, please notify <a href="email">customerservice@themainlabel.com</a>. </p>     

            
            
<div className={styles. termsfooter}> <h3>Can't find what you're looking for? <a href="www.themainalabel.com">Email us</a></h3>
</div>   
